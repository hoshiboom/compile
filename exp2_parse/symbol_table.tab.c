...
{
  "\"end of file\"", "error", "\"invalid token\"", "INTEGER", "ID", "ADD",
  "SUB", "MUL", "DIV", "LP", "RP", "EQUAL", "UMINUS", "';'", "$accept",
  "lines", "line", "expr", "term", "factor", YY_NULLPTR
};
...
{
       3,    -6,     4,    10,    10,    22,     3,    -5,    19,    -6,
      10,    -6,    -6,    15,    -6,    -6,    14,    14,    -6,    14,
      14,    -3,    -6,    19,    19,    -6,    -6,    -6
};
...
{
       0,    14,    15,     0,     0,     0,     3,     0,     6,    10,
       0,    15,     9,     0,     1,     2,     0,     0,     5,     0,
       0,     0,    13,     7,     8,    11,    12,     4
};
...
{
      16,    17,    16,    17,    12,    13,     1,     2,    18,     3,
      27,    21,     4,     1,    11,    10,     3,     1,    11,     4,
      16,    17,    14,     4,    15,    22,    19,    20,    23,    24,
      25,    26
};

static const yytype_int8 yycheck[] =
{
       5,     6,     5,     6,     3,     4,     3,     4,    13,     6,
      13,    10,     9,     3,     4,    11,     6,     3,     4,     9,
       5,     6,     0,     9,     6,    10,     7,     8,    16,    17,
      19,    20
};
...
{
       0,     3,     4,     6,     9,    15,    16,    17,    18,    19,
      11,     4,    17,    17,     0,    15,     5,     6,    13,     7,
       8,    17,    10,    18,    18,    19,    19,    13
};
