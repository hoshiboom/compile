...
class WhileStmt : public StmtNode//�������ԣ�exp-cond��stmt-stmt
{
private:
    ExprNode* cond;
    StmtNode* stmt;
public:
    ...
    bool typeCheck(Type* retType = nullptr){return false;};
    void genCode(){};
    void setStmt(StmtNode* s){this->stmt=s;};//while��stmt���п��ޣ��ʳ�ʼ����Ϊ�գ�����ʶ�𵽵�while�پ����Ƿ�setStmt
};

class BreakStmt : public StmtNode
{//break��Ӧ��ǰ��whileѭ������Ҫ�оֲ�����StmtNode* whileStmt��ʹ�ø���ָ�����Ϳ���ָ������ڵ�?
private:
    StmtNode* whilestmt;
public:
