...
{
    //ï¿½Ú´ï¿½ï¿½ï¿½functionuseï¿½Úµï¿½ï¿½Ê±ï¿½ï¿½ï¿½ï¿½Ð¶ï¿½ï¿½ï¿½Ã»ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
    dst = nullptr;
    SymbolEntry* s = se;
    int paramCnt = 0;//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ê±ï¿½ï¿½Êµï¿½Î¸ï¿½ï¿½ï¿½
    ExprNode* temp = expr;
    while (temp) {
        paramCnt++;
    ...
    while (s) {
        Type* type = s->getType();   //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Íµï¿½entry
        std::vector<Type*> params = ((FunctionType*)type)->getParamsType();   //ï¿½Î²Îµï¿½vector
        if ((long unsigned int)paramCnt == params.size()) {
            this->symbolEntry = s;
            break;
        }
        s = s->getNext();//ï¿½ï¿½ï¿½Òºï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
    }
    if (symbolEntry) {
        ...
        std::vector<Type*> params = ((FunctionType*)type)->getParamsType();//ï¿½Î²ï¿½
        ExprNode* temp = expr;//Êµï¿½ï¿½
...
{
    // Todo
    if (thenStmt)   //ifï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ret
...
{ 
    // Todo ï¿½È½ï¿½ExprNode *retValueï¿½ï¿½typeï¿½Í´ï¿½ï¿½ï¿½ï¿½typeï¿½Ç·ï¿½ï¿½ï¿½Í¬
    ...
    if (type != retType) {
        fprintf(stderr,
                ...
                "of type \'%s\'\n",
                retType->toStr().c_str(), type->toStr().c_str());//ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½×ªï¿½ï¿½
