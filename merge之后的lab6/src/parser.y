%code top{
    ...
    std::stack<StmtNode*> whileStk;//while��䣬ÿ����һ��whileѹջ��break���˵�ǰջ
}
...
Stmt
    ...
    | BlankStmt {
        $$ = $1;//��Ҫ����䣬����while(cond);
        //��Ҫ�õ�ǰ��whileִ����󵯳�whileջ�ͱ����и���䣨��ʶ��������г�ջ�����������ֻҪ�зֺž���
    }
    | BreakStmt {$$=$1;}
    | ContinueStmt {$$=$1;}
    | IfStmt {$$=$1;}
...
WhileStmt
    : WHILE LPAREN Cond RPAREN {
        StmtNode* whileNode = new WhileStmt($3);//ʶ��while���뵽�½ڵ㣬ע��while��CFG��while(cond)stmts
        whileStk.push(whileNode);
    }
    Stmt {  
        StmtNode *whileNode =whileStk.top();
        ((WhileStmt*)whileNode)->setStmt($6);//��stmt����Ҫ�����ڲ�stmt���
        $$=whileNode;
        whileStk.pop();//while��������Զ�pop����
    }
    ;
BreakStmt
    : BREAK SEMICOLON {//break��cotinue��Ե��ǵ�ǰѭ���������Ҫ����while�ڵ�
